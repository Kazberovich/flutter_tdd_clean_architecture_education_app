...
import 'package:tdd_education_app/src/quick_access/presentation/widgets/exam_history_answer_tile.dart';
      ...
      body: SafeArea(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ExamHistoryTile(exam: exam, shouldNavigateToDetails: false),
